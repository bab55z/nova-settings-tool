...
class BaseController
{
    ...
    {
        return config('nova-settings.settings');
    }

    public function localeSettings() : array
    {
        return config('nova-settings.translation');
    }

    public function getDefaultLocale() : string
    {
        return config('nova-settings.translation.default_locale');
    }

    public function getLocales() : array
    {
        return config('nova-settings.translation.locales');
    }
